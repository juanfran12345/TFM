...
## 1. Request Parameters  
    ...
    Name: TFM_Urban_Indices_Spain  

    Date Completed:** 2026-03-06T18:18:24.166670  

    ID: 584f1bf7-036c-476b-8f0c-93ed9630791e  
    ...
    Details:  
        ...
        Layers:  
            ...
            sur_refl_b02 (MOD09A1.061)  
            sur_refl_b06 (MOD09A1.061)  
    
        Coordinates:  

            Madrid, TFM, 40.41694, -3.70333  
            Barcelona, TFM, 41.3825, 2.17694  
            Bilbao, TFM, 43.26306, -2.935  
            Sevilla, TFM, 37.38861, -5.99556  
            Valencia, TFM, 39.47, -0.37639  
            Valladolid, TFM, 41.65198, -4.72856  
            Murcia, TFM, 37.98333, -1.13028  
            Santa Cruz de Tenerife, TFM, 28.46667, -16.25  
            A Corua, TFM, 43.337386, -8.40003  
            Zaragoza, TFM, 41.65, -0.88333  
            AlicanteAlacant, TFM, 38.34528, -0.48306  
            Albacete, TFM, 38.99556, -1.85583  
    
    Version: This request was processed by AppEEARS version 3.112  
...
- Text file with data pool URLs for all source granules used in the extraction
  - TFM-Urban-Indices-Spain-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - TFM-Urban-Indices-Spain-request.json
- xml file
  - TFM-Urban-Indices-Spain-MOD09A1-061-metadata.xml
- xml file
  - TFM-Urban-Indices-Spain-MOD13Q1-061-metadata.xml  
...
Dobson, R., Willis, S. G., Jennings, S., Cheke, R. A., Challinor, A. J., & Dallimer, M. (2024). r-a-dobson/seasonal-forecasting-quelea: v2.0.1 (Version V2.0.1) [Computer software]. Zenodo. https://doi.org/10.5281/ZENODO.14001408. Accessed March 6, 2026.
- Vermote, E. (2021). MODIS/Terra Surface Reflectance 8-Day L3 Global 500m SIN Grid V061. NASA Land Processes Distributed Active Archive Center. https://doi.org/10.5067/MODIS/MOD09A1.061. Accessed March 6, 2026.

## 9. Software Citation  

AppEEARS Team. (2026). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.112. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed March 6, 2026. https://appeears.earthdatacloud.nasa.gov
